        ...
        <div class="absolute inset-0 h-full w-full bg-brand-950">
            ...
            <div class="relative flex h-full flex-col justify-center px-12 text-white">
                ...
                <p class="text-lg text-brand-100/80 max-w-lg mb-8 animate-fade-in-up" style="animation-delay: 200ms">
                    Bergabunglah dengan ribuan bisnis yang telah mendigitalisasi sistem absensi dan payroll mereka.
                </p>
                ...
                <div class="grid grid-cols-2 gap-4 animate-fade-in-up" style="animation-delay: 400ms">
                    <div class="bg-white/5 p-4 rounded-xl backdrop-blur-sm border border-white/10">
                        <div class="text-brand-400 font-bold text-xl mb-0.5">FREE</div>
                        <div class="text-xs text-brand-200">7-Day Trial</div>
                    </div>
                    <div class="bg-white/5 p-4 rounded-xl backdrop-blur-sm border border-white/10">
                        <div class="text-brand-400 font-bold text-xl mb-0.5">Easy</div>
                        <div class="text-xs text-brand-200">Setup Process</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="flex flex-1 flex-col justify-center px-4 py-8 sm:px-6 lg:flex-none lg:px-20 xl:px-24 bg-slate-50/50 h-full overflow-y-auto">
        <div class="mx-auto w-full max-sm lg:w-96">
            ...
            <div class="mb-6 text-center lg:text-left">
                <h2 class="font-display text-2xl font-bold tracking-tight text-slate-900">Buat akun baru</h2>
                <p class="mt-1 text-sm text-slate-600">
                    Sudah punya akun? 
                    <a href="{{ route('login') }}" class="font-semibold text-brand-600 hover:text-brand-500 transition-colors">Masuk di sini</a>
                </p>
            </div>
            ...
            <div>
                ...
                <div class="mt-6">
                    <form method="POST" action="{{ route('register') }}" class="grid grid-cols-1 gap-y-4">
                        @csrf

                        <!-- Name -->
                        <div>
                            <label for="name" class="block text-sm font-semibold leading-6 text-slate-900">Nama Lengkap</label>
                            <div class="mt-1">
                                <input id="name" 
                                    name="name" 
                                    type="text" 
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <!-- Confirm Password -->
                            <div>
                                <label for="password_confirmation" class="block text-sm font-semibold leading-6 text-slate-900">Konfirmasi</label>
                                <div class="mt-1">
                        ...
                        <div class="flex items-center">
                            <input id="terms" name="terms" type="checkbox" required class="h-4 w-4 rounded border-slate-300 text-brand-600 focus:ring-brand-600 transition-all">
                            <label for="terms" class="ml-2.5 block text-xs leading-5 text-slate-700">
                                Saya setuju dengan <a href="#" class="font-semibold text-brand-600 hover:text-brand-500">Syarat & Ketentuan</a>
                            </label>
                        </div>
