    ...
    <div class="flex items-center justify-between mb-8 pb-6 border-b border-gray-100">
        <div>
            <nav class="flex items-center gap-2 text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2">
                ...
                <i class="ti ti-chevron-right text-[8px]"></i>
                <span class="text-indigo-600 font-bold uppercase tracking-widest">Item Baru</span>
            </nav>
            <h1 class="text-3xl font-display font-black text-gray-900 leading-tight">Tambah Item FAQ</h1>
            <p class="text-sm text-gray-500 font-medium">Buat konten tanya jawab baru untuk membantu pengguna landing page.</p>
        </div>
        <div class="flex items-center gap-3">
             ...
             <button type="submit" form="faq-item-create-form" class="inline-flex items-center gap-2 px-7 py-3.5 bg-indigo-600 text-white rounded-2xl font-bold text-sm shadow-xl shadow-indigo-600/20 hover:bg-indigo-700 active:scale-95 transition-all">
                ...
                <div class="space-y-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <textarea name="answer" rows="8" required placeholder="Berikan penjelasan yang detail dan mudah dipahami..."
                            class="w-full bg-gray-50/50 border-gray-200 rounded-[1.25rem] py-4 px-6 text-gray-900 font-medium focus:bg-white focus:ring-4 focus:ring-indigo-100 focus:border-indigo-600 transition-all placeholder:text-gray-300 leading-relaxed">{{ old('answer') }}</textarea>
                    </div>
                </div>
            </div>
        </div>
