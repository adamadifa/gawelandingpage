    ...
    <div class="flex items-center justify-between mb-8 pb-6 border-b border-gray-100">
        <div>
            <nav class="flex items-center gap-2 text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2">
                ...
                <span class="text-indigo-600 font-bold uppercase tracking-widest">Edit Paket</span>
            </nav>
            <h1 class="text-3xl font-display font-black text-gray-900 leading-tight">Perbarui Paket</h1>
            <p class="text-sm text-gray-500 font-medium">Sesuaikan detail tier langganan, harga, dan fitur unggulan untuk mengoptimalkan penawaran.</p>
        </div>
        <div class="flex items-center gap-3">
             ...
             <button type="submit" form="pricing-plan-edit-form" class="inline-flex items-center gap-2 px-7 py-3.5 bg-indigo-600 text-white rounded-2xl font-bold text-sm shadow-xl shadow-indigo-600/20 hover:bg-indigo-700 active:scale-95 transition-all">
