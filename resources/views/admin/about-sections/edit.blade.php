    ...
    <div class="flex items-center justify-between mb-8 pb-6 border-b border-gray-100">
        <div>
            <nav class="flex items-center gap-2 text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2">
                ...
                <i class="ti ti-chevron-right text-[8px]"></i>
                <span class="text-indigo-600">Edit Section</span>
            </nav>
            <h1 class="text-3xl font-display font-black text-gray-900 leading-tight">Perbarui Section Content</h1>
            <p class="text-sm text-gray-500 font-medium">Lakukan penyesuaian pada narasi, media, atau poin unggulan yang ditampilkan.</p>
        </div>
        <div class="flex items-center gap-3">
             ...
             <button type="submit" form="about-edit-form" class="inline-flex items-center gap-2 px-7 py-3.5 bg-indigo-600 text-white rounded-2xl font-bold text-sm shadow-xl shadow-indigo-600/20 hover:bg-indigo-700 active:scale-95 transition-all">
            ...
            <div class="bg-white rounded-[2rem] border border-gray-100 shadow-xl shadow-black/[0.02] p-8 lg:p-10 space-y-8">
                ...
                <div class="space-y-3">
                    ...
                    <textarea name="description" rows="5" required
                        class="w-full bg-gray-50/50 border-gray-200 rounded-[1.25rem] py-4 px-6 text-gray-900 font-medium focus:bg-white focus:ring-4 focus:ring-indigo-100 focus:border-indigo-600 transition-all leading-relaxed placeholder:text-gray-300">{{ old('description', $about_section->description) }}</textarea>
                </div>
            </div>
            ...
            <div class="bg-white rounded-[2rem] border border-gray-100 shadow-xl shadow-black/[0.02] p-8 space-y-8">
                ...
                <div class="space-y-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="relative group bg-white border-2 border-dashed border-gray-200 rounded-[1.5rem] overflow-hidden hover:border-indigo-600 hover:bg-white transition-all cursor-pointer shadow-inner">
            ...
            <div class="bg-white rounded-[2rem] border border-gray-100 shadow-xl shadow-black/[0.02] p-8 space-y-8">
                <div class="flex items-center gap-3 p-1">
                    <label class="relative inline-flex items-center cursor-pointer">
                        ...
                        <span class="ml-3 text-sm font-bold text-gray-700">Tampilkan Section Ini</span>
                    </label>
                </div>
