...
<nav class="flex items-center gap-2 text-[10px] font-semibold text-gray-400 uppercase tracking-widest mb-2 font-poppins">
    ...
    <i class="ti ti-chevron-right text-[8px]"></i>
    <span class="text-brand-600 font-semibold">Tambah Section</span>
</nav>
@endsection
...
<div class="flex items-center gap-3 font-poppins">
     ...
     <button type="submit" form="about-create-form" class="inline-flex items-center gap-2 px-7 py-3.5 bg-brand-600 text-white rounded-xl font-bold text-sm shadow-xl shadow-brand-600/20 hover:bg-brand-700 active:scale-95 transition-all">
            ...
            <div class="bg-white rounded-xl border border-gray-100 shadow-xl shadow-black/[0.02] p-8 lg:p-10 space-y-6">
                ...
                <div class="space-y-3">
                    ...
                    <textarea name="description" rows="5" required
                        class="w-full bg-gray-50/50 border-gray-200 rounded-xl py-4 px-6 text-gray-900 font-medium focus:bg-white focus:ring-4 focus:ring-brand-100/30 focus:border-brand-600 transition-all leading-relaxed placeholder:text-gray-300 shadow-sm"
            ...
            <div class="bg-white rounded-xl border border-gray-100 shadow-xl shadow-black/[0.02] p-8 space-y-6">
                ...
                <div class="space-y-8">
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="relative group bg-gray-50 border-2 border-dashed border-gray-200 rounded-xl overflow-hidden hover:border-brand-600 hover:bg-white transition-all cursor-pointer shadow-inner">
            ...
            <div class="bg-white rounded-xl border border-gray-100 shadow-xl shadow-black/[0.02] p-8 space-y-6">
                <div class="flex items-center gap-3 p-1">
                    <label class="relative inline-flex items-center cursor-pointer">
                        ...
                        <span class="ml-3 text-sm font-semibold text-gray-700">Aktifkan Section Ini</span>
                    </label>
                </div>
...
<script>
    ...
    function addItem() {
        ...
        newItem.innerHTML = `
            ...
            <input type="text" name="feature_items[]" required placeholder="Tulis poin keunggulan di sini..."
                class="flex-1 bg-gray-50/50 border-gray-200 rounded-xl py-3.5 px-6 text-sm font-bold text-gray-700 focus:bg-white focus:ring-4 focus:ring-brand-100/30 focus:border-brand-600 transition-all">
