...
<nav class="flex items-center gap-2 text-[10px] font-semibold text-gray-400 uppercase tracking-widest mb-2 font-poppins">
    ...
    <i class="ti ti-chevron-right text-[8px]"></i>
    <span class="text-brand-600 font-semibold">Edit Partner</span>
</nav>
@endsection
...
<div class="flex items-center gap-3 font-poppins">
     ...
     <button type="submit" form="partner-edit-form" class="inline-flex items-center gap-2 px-7 py-3.5 bg-brand-600 text-white rounded-xl font-bold text-sm shadow-xl shadow-brand-600/20 hover:bg-brand-700 active:scale-95 transition-all">
                            ...
                            <div id="logo-preview-container" class="flex flex-col items-center justify-center py-10 px-6">
                                @if($trusted_company->logo)
                                    <div class="relative w-full max-w-[280px] group/preview">
                                        <img src="{{ asset('storage/' . $trusted_company->logo) }}" class="w-full h-auto max-h-[220px] object-contain rounded-xl shadow-xl shadow-brand-600/10 border border-gray-100 bg-white p-2">
