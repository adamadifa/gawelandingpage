...
<nav class="flex items-center gap-2 text-[10px] font-semibold text-gray-400 uppercase tracking-widest mb-2 font-poppins">
    ...
    <i class="ti ti-chevron-right text-[8px]"></i>
    <span class="text-brand-600 font-semibold">Edit Versi</span>
</nav>
@endsection
...
<div class="flex items-center gap-3 font-poppins">
     ...
     <button type="submit" form="feature-edit-form" class="inline-flex items-center gap-2 px-7 py-3.5 bg-brand-600 text-white rounded-xl font-bold text-sm shadow-xl shadow-brand-600/20 hover:bg-brand-700 active:scale-95 transition-all">
...
<div class="w-full -mt-6 space-y-6 pb-0 font-poppins">
    ...
    <form id="feature-edit-form" action="{{ route('admin.feature-sections.update', $feature_section->id) }}" method="POST" enctype="multipart/form-data" class="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start font-poppins">
        ...
        <div class="lg:col-span-7 space-y-6 text-inter">
                    ...
                    <div class="relative group bg-white border-2 border-dashed border-gray-200 rounded-xl overflow-hidden hover:border-brand-600 hover:bg-white transition-all cursor-pointer shadow-inner">
                        <div class="aspect-[16/10] w-full flex flex-col items-center justify-center p-6 text-center">
                            ...
                            @else
                                ...
                                <p class="text-[11px] font-bold text-gray-400 uppercase tracking-widest" id="text-preview">Unggah Gambar Mockup</p>
                            @endif
                            ...
                            <div class="absolute inset-0 bg-brand-900/60 opacity-0 group-hover:opacity-100 transition-all duration-500 flex items-center justify-center z-30 pointer-events-none">
                                <div class="bg-white text-brand-600 text-[10px] font-bold uppercase tracking-widest px-6 py-3 rounded-full shadow-2xl scale-90 group-hover:scale-100 transition-transform">Ganti File Visual</div>
                            </div>
                        </div>
                    </div>
