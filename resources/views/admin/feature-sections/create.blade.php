    ...
    <div class="flex items-center justify-between mb-8 pb-6 border-b border-gray-100">
        <div>
            <nav class="flex items-center gap-2 text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2">
                ...
                <i class="ti ti-chevron-right text-[8px]"></i>
                <span class="text-indigo-600">Tambah Versi</span>
            </nav>
            <h1 class="text-3xl font-display font-black text-gray-900 leading-tight">Buat Versi Section Baru</h1>
            <p class="text-sm text-gray-500 font-medium">Rancang headline dan mockup visual untuk section fitur unggulan Anda.</p>
        </div>
        <div class="flex items-center gap-3">
             ...
             <button type="submit" form="feature-create-form" class="inline-flex items-center gap-2 px-7 py-3.5 bg-indigo-600 text-white rounded-2xl font-bold text-sm shadow-xl shadow-indigo-600/20 hover:bg-indigo-700 active:scale-95 transition-all font-poppins">
                ...
                <div class="space-y-6">
                    <div class="relative group bg-white border-2 border-dashed border-gray-200 rounded-[2rem] overflow-hidden hover:border-indigo-600 hover:bg-white transition-all cursor-pointer shadow-inner">
                        <div class="aspect-[16/10] w-full flex flex-col items-center justify-center p-6">
                            ...
                            <p class="text-[11px] font-black text-gray-400 uppercase tracking-widest text-center" id="text-preview">Unggah Gambar Mockup</p>
                            ...
                            <div class="absolute inset-0 bg-indigo-900/60 opacity-0 group-hover:opacity-100 transition-all duration-500 flex items-center justify-center z-30">
                                <div class="bg-white text-indigo-600 text-[10px] font-black uppercase tracking-widest px-6 py-3 rounded-full shadow-2xl scale-90 group-hover:scale-100 transition-transform">Pilih File Baru</div>
                            </div>
                        </div>
                    </div>
